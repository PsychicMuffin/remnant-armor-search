...
Builds the app for production and then deploys the `build` folder to the gh-pages branch. Github
Pages detects its watched folder has updated, and publishes an update to the site. This is all
handled by [gh-pages](https://www.npmjs.com/package/gh-pages).
